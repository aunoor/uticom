...
void SerInit(void) {
  ...
  bDLL1 =	BaudRate9600_DLL;	//	9600			*
  bDLH1 =	BaudRate9600_DLH;	//	9600			*
...
BYTE xdata	myvec2[2];
	myvec2[1]=0;
	if (bLSR1 & 0x1) myvec2[0]=myvec2[0] | LCR_OVR;
	if (bLSR1 & 0x2) myvec2[0]=myvec2[0] | LCR_PTE;
	if (bLSR1 & 0x4) myvec2[0]=myvec2[0] | LCR_FRE;
	if (bLSR1 & 0x8) myvec2[0]=myvec2[0] | LCR_BRK;
